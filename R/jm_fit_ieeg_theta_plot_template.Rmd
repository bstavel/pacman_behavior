---
title: "JM Model Fitting - iEEG Theta Sample"
...
if (permuted) {
  ...
  write_csv(metrics_df, path(here(), "data", "joint_models", "model_summaries", 
                             paste0(current_subject, "_permuted_fit_metrics_theta_power_model_df_ofc.csv")))
  write_csv(survival_df, path(here(), "data", "joint_models", "model_summaries", 
                              paste0(current_subject, "_permuted_model_params_theta_power_model_df_ofc.csv")))

} else {
  
  
  write_csv(metrics_df, path(here(), "data", "joint_models", "model_summaries", 
                             paste0(current_subject, "_fit_metrics_theta_power_model_df_ofc.csv")))
  write_csv(survival_df, path(here(), "data", "joint_models", "model_summaries", 
                              paste0(current_subject, "_model_params_theta_power_model_df_ofc.csv")))
