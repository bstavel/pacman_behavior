...
for(current_seed in sample(1:100, 10)){
...
write_csv(metrics_df, path(here(), "data", "joint_models", "model_summaries", paste0(current_subject, "fit_metrics_base_model_df.csv")))
write_csv(survival_df, path(here(), "data", "joint_models", "model_summaries", paste0(current_subject, "model_params_base_model_df.csv")))
