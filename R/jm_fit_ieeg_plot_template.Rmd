---
title: "JM Base Model Fitting - iEEG Sample"
...
if(permuted){
    ...
    write_csv(metrics_df, path(here(), "data", "joint_models", "model_summaries", 
                             paste0(current_subject, "_permuted_fit_metrics_base_model_df.csv")))
    write_csv(survival_df, path(here(), "data", "joint_models", "model_summaries", 
                              paste0(current_subject, "_model_params_base_model_df.csv")))
    ...
    write_csv(metrics_df, path(here(), "data", "joint_models", "model_summaries", 
                             paste0(current_subject, "permuted_fit_metrics_base_model_df.csv")))
    write_csv(survival_df, path(here(), "data", "joint_models", "model_summaries", 
                              paste0(current_subject, "_model_params_base_model_df.csv")))
