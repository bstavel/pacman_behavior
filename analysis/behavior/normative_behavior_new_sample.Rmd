...
write_csv(pilot_behave_data, path(here(), "munge", "prolific", "cleaned_pilot_behavior_newsample_2-3-24.csv"))
write_csv(pilot_game_data_clean, path(here(), "munge", "prolific", "cleaned_pilot_game_data_newsample_2-3-24.csv"))
write_csv(pilot_game_data_distance, path(here(), "munge", "prolific", "cleaned_pilot_distance_data_newsample_2-3-24.csv"))
write_csv(pilot_all_vars_df, path(here(), "munge", "prolific", "cleaned_pilot_across_trial_data_newsample_2-3-24.csv"))
