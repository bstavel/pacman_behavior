...
png(path(here(), "figures", "survival", "roc_behave_plot.png"), width = 7, height = 5.25, units = 'in', res = 300)
...
ggsave(path(here(), "figures", "survival", "survival_theta_prediction_plot.png"), cns_pred_surv_plot, width = 7, height = 7.5)
...
ggsave(path(here(), "figures", "survival", "correlation_theta_prediction_plot.png"), cns_cor_plot, width = 6, height = 7.5)
...
png(path(here(), "figures", "survival", "roc_theta_behave_plot.png"), width = 6, height = 5.75, units = 'in', res = 300)
