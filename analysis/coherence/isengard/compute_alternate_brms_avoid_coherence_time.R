...
sig_df <- read_csv(path(here(), "results", "sig_theta_threshold_pairs.csv"))
...
# 
# # save rising model #
# save(falling_model, file = path(here(), "results", paste0(avd_time_window, "_falling_model_all_elecs_brms.RData")))
# 
# 
# # summary #
...
# 
# # save rising model #
# save(falling_model, file = path(here(), "results", paste0(avd_time_window, "_falling_model_50_elecs_brms.RData")))
# 
# 
# # summary #
# summary(falling_model)
