...
# save rising model #
# save(rising_model, file = path(here(), "results", "rising_model_brms.RData"))
...
# save falling model #
# save(falling_model, file = path(here(), "results", "falling_model_brms.RData"))
