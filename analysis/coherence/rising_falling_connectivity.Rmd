...
imcoh_sig_ex_app_plot <- indv_imcoh_sig_avg_plot_df %>%
  ...
  theme(panel.background = element_rect(fill = "white"), 
    ...
    plot.title = element_text(family = "Gill Sans", color = "#2D2327", size = 8, hjust = .5, face = 'plain')) +
  labs(color = "", fill = "", y = "Imaginary Coherence, logged", x = "Approach Time (s)") +
  ggtitle("Approach")
...
ggsave(path(here(), "figures", "connectivity", "fig3_example_sub_approach.png"), 
       ...
       width = 1.5, height = 2.75, units = "in", dpi = 600)
...
imcoh_sig_ex_avd_plot <- indv_imcoh_sig_avg_plot_df %>%
  ...
  theme(panel.background = element_rect(fill = "white"), 
    ...
    axis.title =  element_text(family = "Gill Sans", color = "#2D2327", size = 7),
    plot.title = element_text(family = "Gill Sans", color = "#2D2327", size = 8, hjust = .5, face = 'plain')) +
  labs(color = "", fill = "", y = "Imaginary Coherence, logged", x = " Avoidance Time (s)") +
  ggtitle("Avoid")
