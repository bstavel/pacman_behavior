...
```{r load-data}
# game data #
pilot_game_data <- read_csv('../../pacman_parse/missing_data_7_1_2021.csv', col_types = cols())

# behave data #
pilot_behave_data <- read_csv('../../pacman_parse/cleaned_behave_data_6_24_2021.csv')
...
```{r clean-up}
# clean Biscuits #
pilot_game_data <- pilot_game_data %>%
  # mutate(across(starts_with("Bis"), ~ gsub("\"", "", .x))) %>%
