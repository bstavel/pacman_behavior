...
survival_plot <- ggsurvplot(basic_aalen_fit, 
           ...
           ylab = "Probability of turning around",
           ggtheme = theme_bw(base_family = 'Georgia'),
           font.family = "Georgia",
           font.main = c(16, "bold"),
           font.x = c(14),
           font.y = c(14),
           ...
           palette = c("#E48DB7", "#FFA801", "#55BBC8", "#FFA801", "#DE0D16", "#FFA801")) +
  ggtitle("Players moved towards dots/ghost for about\n 1-2 seconds before turning around")


ggsave(filename = path(here(), "figures", "SFN", "survival_plot.tif"),
     device = "tiff",
     width = 6,
     height = 4,
     units = "in",
