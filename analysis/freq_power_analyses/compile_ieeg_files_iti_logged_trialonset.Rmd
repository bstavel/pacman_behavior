...
```{r merge-and-combine-amyg, eval = F}
...
```{r merge-and-combine-ofc, eval = F}
...
```{r merge-and-combine-cing, eval = F}
...
```{r merge-and-combine-dlpfc, eval = F}

for(frq in freq_list[5:6]){
