...
bad_trials <- read_csv(path(here(), './data/ieeg_behave/BJH021_bad_trials.csv'))


tmp <- read_csv(path(here(), './data/ieeg_behave/BJH021_died_events.csv'))

create_last_away_events(bjh21_data_clean, 'BJH021_last_away_events.csv')
create_first_dot_events(bjh21_data_clean, 'BJH021_first_dot_events.csv')
create_first_move_events(bjh21_data_clean, 'BJH021_first_move_events.csv')
create_died_events(bjh21_data_clean, 'BJH021_died_events.csv')
