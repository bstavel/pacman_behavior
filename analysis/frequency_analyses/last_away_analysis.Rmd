...
hc_average <- theta_onset_plot_df %>% select(region, trial_time, roi_average) %>% distinct() %>% filter(region == "hc") %>% pull(roi_average)
amyg_average <- theta_onset_plot_df %>% select(region, trial_time, roi_average) %>% distinct() %>% filter(region == "amyg") %>% pull(roi_average)
ofc_average <- theta_onset_plot_df %>% select(region, trial_time, roi_average) %>% distinct() %>% filter(region == "ofc") %>% pull(roi_average)
cing_average <- theta_onset_plot_df %>% select(region, trial_time, roi_average) %>% distinct() %>% filter(region == "cing") %>% pull(roi_average)
dlpfc_average <- theta_onset_plot_df %>% select(region, trial_time, roi_average) %>% distinct() %>% filter(region == "dlpfc") %>% pull(roi_average)
insula_average <- theta_onset_plot_df %>% select(region, trial_time, roi_average) %>% distinct() %>% filter(region == "insula") %>% pull(roi_average)


cor.test(hc_average, amyg_average)
