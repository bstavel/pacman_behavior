...
# OFC and hfa Onset Before Turnaround plot
individual_and_overall_robust_lme_onset_before_turn_model_and_plot("OFC", "hfa", 
                                all_subs_g_dist, ofc_hfa_data, 
                                y_low = -6, y_high = 6,
                                plot_title = "hfa encodes reward and threat values in the OFC at trial onset",
                                rerun_model = TRUE)


# #OFC and hfa Onset at Turnaround plot
# individual_and_overall_robust_lme_onset_turnaround_model_and_plot("OFC", "hfa", 
#                                 all_subs_g_dist, ofc_hfa_data, 
#                                 y_low = -5, y_high = 5,
#                                 plot_title = "hfa does not encode threat or reward values in the OFC after Turnaround",
#                                 rerun_model = TRUE)


# #OFC and hfa Onset Discounted value
# individual_and_overall_lme_onset_combval_before_turn_model_and_plot("OFC", "hfa", 
#                                 all_subs_g_dist, ofc_hfa_data, 
...
# #OFC and hfa Onset Combined value
# individual_and_overall_lme_onset_combval_before_turn_model_and_plot("OFC", "hfa", 
#                                 all_subs_g_dist, ofc_hfa_data, 
