...
#                                 y_low = -.5, y_high = .5,
#                                 plot_title = "Theta ... amyg... Trial Onset",
#                                 rerun_model = TRUE)

# # Turnaround
# individual_and_overall_robust_lme_turnaround_model_and_plot("amyg", "theta", 
#                                 all_subs_g_dist, amyg_theta_data, 
#                                 y_low = -.5, y_high = .5,
#                                 plot_title = "Theta ... amyg... Turnaround",
#                                 rerun_model = TRUE)
...
individual_and_overall_lme_onset_combval_turnaround_model_and_plot("amyg", "theta", 
                                all_subs_g_dist, amyg_theta_data, 
                                predictor = "distance_to_ghost",
                                y_low = -.5, y_high = .5,
                                plot_title = "Theta ... amyg... Turnaround",
...
# individual_and_overall_robust_split_lme_onset_before_turn_model_and_plot("amyg", "theta", 
#                                 all_subs_g_dist, amyg_theta_data, 
#                                 y_low = -.5, y_high = .5,
#                                 plot_title = "Theta ... amyg... Trial Onset",
#                                 rerun_model = TRUE)

# for (sub in unique(amyg_theta_data$subject)) {

#   print(sub)
#   idx = which(sub == unique(amyg_theta_data$subject))

#   if(sub %in% c("LL17", "LL19", "LL10", "BJH039")){
#     next
#   }


#   individual_subject_robust_lme_onset_before_turn_model_and_plot("amyg", "theta", sub, c25[idx],
#                                 all_subs_g_dist, amyg_theta_data, 
#                                 y_low = -3, y_high = 3,
#                                 plot_title = paste0("Theta, amyg, ", sub),
#                                 rerun_model = TRUE)
# }   

# ## Interaction Model

# individual_and_overall_robust_interact_lme_onset_before_turn_model_and_plot("amyg", "theta", 
#                                 all_subs_g_dist, amyg_theta_data, 
