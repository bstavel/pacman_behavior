...
ofc_beta_data <- read_csv( path(here(), "munge", "beta_ieeg_ofc_all_subs_logged_iti_onset.csv"))
...
## Combined Model ##
# Onset
individual_and_overall_robust_lme_onset_before_turn_model_and_plot("ofc", "beta", 
                                all_subs_g_dist, ofc_beta_data, 
                                y_low = -.5, y_high = .5,
                                plot_title = "beta ... ofc... Trial Onset",
                                rerun_model = TRUE)

# Turnaround

individual_and_overall_robust_lme_turnaround_model_and_plot("ofc", "beta", 
                                all_subs_g_dist, ofc_beta_data, 
                                y_low = -.5, y_high = .5,
                                plot_title = "beta ... ofc... Turnaround",
                                rerun_model = TRUE)

## Indiviudal Predictors ##
# Distance to Ghost
individual_and_overall_lme_onset_combval_before_turn_model_and_plot("ofc", "beta", 
                                all_subs_g_dist, ofc_beta_data, 
...
individual_and_overall_robust_split_lme_onset_before_turn_model_and_plot("ofc", "beta", 
                                all_subs_g_dist, ofc_beta_data, 
                                y_low = -.5, y_high = .5,
                                plot_title = "beta ... OFC... Trial Onset",
                                rerun_model = TRUE)
