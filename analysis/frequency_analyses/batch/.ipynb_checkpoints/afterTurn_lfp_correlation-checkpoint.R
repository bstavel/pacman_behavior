...
#     }, TRUE)
# try({
#     compute_lfp_correlation(sub_list, "dlpfc", "cing", theta_turnaround_df, "after_only")
#     }, TRUE)
# try({
#     compute_lfp_correlation(sub_list, "dlpfc", "amyg", theta_turnaround_df, "after_only")
#     }, TRUE)
# try({
#     compute_lfp_correlation(sub_list, "dlpfc", "insula", theta_turnaround_df, "after_only")
#     }, TRUE)
