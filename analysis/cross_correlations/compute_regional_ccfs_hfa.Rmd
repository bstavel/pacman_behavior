...
# ieeg data #
ofc_theta_data <- read_csv( path(here(), "munge", paste0(freq, "_ieeg_ofc_all_subs_logged_iti_onset_highres.csv")))
amyg_theta_data <- read_csv( path(here(), "munge", paste0(freq, "_ieeg_amyg_all_subs_logged_iti_onset_highres.csv")))
hc_theta_data <- read_csv( path(here(), "munge", paste0(freq, "_ieeg_hc_all_subs_logged_iti_onset_highres.csv")))
cing_theta_data <- read_csv( path(here(), "munge", paste0(freq, "_ieeg_cing_all_subs_logged_iti_onset_highres.csv")))
dlpfc_theta_data <- read_csv( path(here(), "munge", paste0(freq, "_ieeg_dlpfc_all_subs_logged_iti_onset_highres.csv")))
...
rm(ofc_theta_data, amyg_theta_data, hc_theta_data, cing_theta_data, dlpfc_theta_data, mfg_theta_data)
...
ccf_amyg_acc_null_results <- run_and_save_perms(amyg_acc_df, amyg_cing_sig_pairs, "null_ccf_amyg_acc_hfa_results.csv")
