...
ccf_ofc_acc_null_results <- run_and_save_perms(ofc_acc_df, 
                                               sig_pairs, 
                                               all_subs_theta_data, "null_ccf_ofc_acc_results.csv", perms_run = 110)
...
ccf_ofc_hc_null_results <- run_and_save_perms(ofc_hc_df, sig_pairs, all_subs_theta_data, "null_ccf_ofc_hc_results.csv"s)
