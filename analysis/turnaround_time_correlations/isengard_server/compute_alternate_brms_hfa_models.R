...
# 
# ## save full model ##
# save(model, file = path(here(), "results", "full_hfa_all_roi_100_elecs_model_brms.RData"))
...
## save full model ##
save(model, file = path(here(), "results", "full_hfa_all_roi_10a_elecs_model_brms.RData"))
