...
sub_elec_ci_theta_orig <- left_join(sub_elec_ci_theta, sig_orig_list) %>%
  filter(!is.na(sig))
table(sub_elec_ci_theta_orig$significant_key, sub_elec_ci_theta_orig$roi_pair)
...
sub_elec_ci_theta_50 <- left_join(sub_elec_ci_theta, sig_50_list) %>%
  filter(!is.na(sig))
table(sub_elec_ci_theta_50$significant_key, sub_elec_ci_theta_50$roi_pair)
...
sub_elec_ci_theta_100 <- left_join(sub_elec_ci_theta, sig_100_list) %>%
  filter(!is.na(sig))
table(sub_elec_ci_theta_100$significant_key, sub_elec_ci_theta_100$roi_pair)
...
table(sub_elec_ci_hfa$significant_sub)/nrow(sub_elec_ci_hfa)
...
sub_elec_ci_hfa_orig <- left_join(sub_elec_ci_hfa, sig_orig_list) %>%
  filter(!is.na(sig))
table(sub_elec_ci_hfa_orig$significant_key, sub_elec_ci_hfa_orig$roi_pair)
...
sub_elec_ci_hfa_50 <- left_join(sub_elec_ci_hfa, sig_50_list) %>%
  filter(!is.na(sig))
table(sub_elec_ci_hfa_50$significant_key, sub_elec_ci_hfa_50$roi_pair)
...
sub_elec_ci_hfa_100 <- left_join(sub_elec_ci_hfa, sig_100_list) %>%
  filter(!is.na(sig))
table(sub_elec_ci_hfa_100$significant_key, sub_elec_ci_hfa_100$roi_pair)
