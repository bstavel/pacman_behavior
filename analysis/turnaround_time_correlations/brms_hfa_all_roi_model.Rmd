...
turn_time_plot <- full_sample_plot_df %>%
  ...
  ylim(0, 80) +
  ggtitle("Turnaround Time Correlates with Trial-by-Trial HFA Connectivity", subtitle = "Each facet shows the posterior distribution for the slope for each region pair, * indicates the 95% CI did not include 0")

# ggsave(path(here(), "figures", "correl_turn_predictions", "hfa_turn_time_plot_newsubs.png"),
#        plot = turn_time_plot,
